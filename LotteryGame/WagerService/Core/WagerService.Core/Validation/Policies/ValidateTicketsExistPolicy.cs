namespace WagerService.Core.Validation.Policies
{
    ...
    public class ValidateTicketsExistPolicy : IOperationPolicy<TicketOperationContext>
    {
        ...
        public async Task<ResponseDto> ExecuteAsync(TicketOperationContext context)
        {
